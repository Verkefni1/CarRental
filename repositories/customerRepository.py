        ...
        with open("./data/Customer.csv", 'r') as customer_file:
            ...
            with open("./data/customerTmp.csv", 'w+') as customer_file_tmp:
                ...
                for cus in reader:
                    if ssn == cus[4]:
                        if edit_action == "1":
                            cus = [change, cus[1], cus[2], cus[3], cus[4], cus[5]]
                        elif edit_action == "2":
                            cus = [cus[0], change, cus[2], cus[3], cus[4], cus[5]]
                        elif edit_action == "3":
                            cus = [cus[0], cus[1], change, cus[3], cus[4], cus[5]]
                        elif edit_action == "4":
                            cus = [cus[0], cus[1], cus[2],  change], cus[4], cus[5]]
                        elif edit_action == "5":
                            cus = [cus[0], cus[1], cus[2], cus[3], change, cus[5]]
                        elif edit_action == "6":
                            cus = [cus[0], cus[1], cus[2], cus[3], cus[4], change]
                        elif cus == []:
                            pass
                        else:
                            writer.writerow(cus)
